...
export default function AboutSection() {
  return (
    <section id="presentation" className="section-spacing bg-primary relative overflow-hidden">
      ...
      <div className="container relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal animation="animate-slideInUp">
            <div className="flex flex-col gap-8">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-xl font-bold text-red-200">Dr. Bérété Alpha</p>
              ...
              <div className="space-y-4">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-white mb-1">Soins de Qualité</h3>
          ...
          <ScrollReveal animation="animate-scaleIn" delay={0.2}>
            <div className="relative rounded-2xl overflow-hidden h-56 md:h-72 border-2 border-white/20 group">
              <img
