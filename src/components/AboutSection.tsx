      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-8 animate-slideInUp">
            ...
            <div className="bg-gray-50 rounded-lg p-6 border border-border inline-block">
          ...
          <div className="animate-scaleIn" style={{ animationDelay: '0.2s' }}>
            <div className="relative rounded-lg overflow-hidden h-80 md:h-96 border border-border">
              <img
